...
category: Mobile
preview: Design and develop native iOS inventory app prototype for a second-hand shop
imageUrl: /assets/kleiderbar/cover.jpg
date: 2017-12-20
---
...
- <a href="https://github.com/LadislavSzolik/Kleiderbar-Ver2">Github code</a>
...
<CustomImageTag
  url="/assets/kleiderbar/kleiderbar_shop.jpeg"
  alt="In the second-hand shop"
/>
...
<CustomImageTag
  url="/assets/kleiderbar/early_designs.png"
  alt="First iteration of the client registration"
/>
<em>
  The first iteration where I used built in iOS UI to test how easy is to add new client
</em>
...
<CustomImageTag
  url="/assets/kleiderbar/iterations.png"
  alt="Simplifying item entry through iterations"
/>
